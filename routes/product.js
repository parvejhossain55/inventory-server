...
router.get("/products/related-products/:productId/:categoryId", ProductController.getRelatedProducts);
...
// POST new product
router.post("/products", isAuthenticated, isAdmin, upload.single("images"), ProductController.createProduct);

// PATCH update product by ID
router.patch("/products/:slug", isAuthenticated, isAdmin, upload.single('images'), ProductController.updateProductBySlug);
